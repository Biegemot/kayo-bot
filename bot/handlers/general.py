...
Ночной житель — активен ночью (22:00-04:00)
Ранний зверь — активен утром (05:00-11:00)
Тихий, но опасный — меньше 10 сообщений, но активен
Призрак — не был в сети больше 7 дней

**Взаимодействия:**
Обнимашка — больше 10 /hug за день
Злюка — больше 10 /bite за день
Ласковый — больше 10 /pat за день
Няшный — больше 10 /boop за день
Поцелуйчик — больше 5 /kiss за день
Шлёпало — больше 5 /slapass за день

**Темы сообщений:**
Геймер — часто упоминает игры
Программист — часто упоминает код
Музыкальный — часто упоминает музыку
Едок — часто упоминает еду
Фурри-художник — часто упоминает рисование/арт
Косплейер — часто упоминает косплей
